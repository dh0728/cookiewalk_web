...
## :pencil: 소감 및 느낀점 ##
저를 포함한 팀원들 모두 비전공자이고 개발관련 프로젝트 경험이 부족하다보니 프로젝트 주제 선정, 구현 기능 정의 및 구현 방법등 프로젝트를 진행함에 있어서 많은 어려움을 겪었습니다. 하지만 모두 함께 문제들을 해결해나가면서 프로젝트를 진행하여 좋은 결과를 얻으면서 마무리 할 수 있었습니다. 
