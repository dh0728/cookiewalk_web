...
## :pencil: 소감 및 느낀점 ##
저를 포함한 팀원들 모두 비전공자이고 개발관련 프로젝트 경험이 부족하다보니 프로젝트 주제 선정, 구현 기능 정의 및 구현 방법등 프로젝트를 진행함에 있어서 많은 어려움을 겪었습니다. 하지만 모두 함께 문제들을 해결해나가면서 프로젝트를 진행하여 좋은 결과를 얻으면서 저의 첫 번째 프로젝트를  마무리 할 수 있었습니다. <br>
아직 부족한 것이 많은 만큼 더 열심히 공부해 개발자로써 필요한 능력을 쌓아 좋은 개발자가 되도록 노력할 것입니다. 
